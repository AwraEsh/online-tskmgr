...
- **پردازشها**: پرمصرفترین پردازشهای CPU و RAM
...
- **هشدار دمایی**: پیام جداگانه وقتی CPU/GPU از آستانه دما رد بشه، با خنک شدن خودکار پاک میشه
- **تغییر آستانه دما**: دکمه برای تغییر آستانه هشدار دمایی (0-110C) از داخل چت، با تایم‌اوت 1 دقیقه و امکان لغو
- **ریست آستانه**: دکمه "Reset 90C" آستانه رو فوری به مقدار پیشفرض 90C برمیگردونه
- **توقف هوشمند**: هشدارهای دمایی موقع ورود آستانه جدید متوقف میشن تا چت شلوغ نشه
...
|--------|--------------|------|
| `ALERT_THRESHOLD` | 90C | آستانه دما برای هشدار دمایی (قابل تغییر از .env یا دکمه ربات) |
| `INTERVAL_NORMAL` | 3s | فاصله آپدیت آمار |
...
| `/cancel` | لغو ورودی آستانه در انتظار |
